...
def get_by_id(id):
    init.dbcursor.execute("SELECT Kaffeetemp_ID, Hersteller, Name, Herkunft, Anbauart, Besonderheit, Geschmacksprofil, Preis_1000g, Preis_500g, Preis_250g, Preis_100g FROM Kaffeetemp WHERE Kaffeetemp_ID = " + id)
    result = init.dbcursor.fetchall()
    print(result)
    return result[0]
...
def update(id, hersteller, name, herkunft, anbauart, besonderheit, geschmacksprofil, preis_1000g, preis_500g, preis_250g, preis_100g):
    ...
    sql = sql + "WHERE Kaffeetemp_ID = " + id
