...
def fill():
    for x in range(10):
        ...
        models.kaffee.insert(hersteller, name, herkunft, anbauart, besonderheit, geschmacksprofil, preis_1000g, preis_500g, preis_250g, preis_100g)

    return 1

def get_all():
    return models.kaffee.get_all()

def get_by_id(id):
    return models.kaffee.get_by_id(id)

def loeschen(id):
    return models.kaffee.delete_by_id(id)
...
def update(id, hersteller, name, herkunft, anbauart, besonderheit, geschmacksprofil, preis_1000g, preis_500g, preis_250g, preis_100g):
    ...
    models.kaffee.update(id, hersteller, name, herkunft, anbauart, besonderheit, geschmacksprofil, preis_1000g, preis_500g, preis_250g, preis_100g)
